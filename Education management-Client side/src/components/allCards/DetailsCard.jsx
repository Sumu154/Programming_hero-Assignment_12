...
const DetailsCard = ( {course_id, course_price, user_enrollment, course_image } ) => {
  ...
  return (
    <div className='bg-white border-dark/15 border-[1px] hover:border-purple p-2 sm:max-w-[320px] sm:mx-auto -mt-10 sm:-mt-12 lg:-mt-[166px]  dark:bg-cardbackground '>
      ...
      <div className='dark:text-white'>
        <p className='text-dollargreen text-xl font-bold flex items-center gap-1 '> <span className=''> <BsCurrencyDollar /> </span> {course_price} </p>
        <div className='my-3 mb-9'> <Link to={`/classes/${course_id}/payment`}> <button className='w-full bg-orchid/95  hover:bg-orchid px-6 py-[6px] text-white '> Pay for this course </button> </Link> </div>
