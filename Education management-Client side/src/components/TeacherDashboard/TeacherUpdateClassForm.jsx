...
const TeacherUpdateClassForm = ( {course_id} ) => {
  ...
  return (
    ...
    <div className='w-full bg-orchid/10 my-14 p-5 border-[1px] border-dark/10 '>
      <div className='flex justify-center'> <h3 className='px-3 text-center  border-b-[2px] border-purple font-semibold mb-8 text-2xl md:text-3xl'> Update Class </h3> </div>      
      {/* form */}
      <form onSubmit={handleClassUpdate} className="mt-4">
...
export default TeacherUpdateClassForm;